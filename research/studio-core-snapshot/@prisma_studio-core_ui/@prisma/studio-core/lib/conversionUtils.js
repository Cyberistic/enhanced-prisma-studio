...
export function coerceToValue(column, operator, value) {
    ...
    if (dataTypeGroup === "boolean")
        return value === "true";
    if (dataTypeGroup === "datetime")
        return value;
    if (dataTypeGroup === "enum")
        return value;
    if (dataTypeGroup === "raw")
        return value;
    if (dataTypeGroup === "string")
        return value;
    if (dataTypeGroup === "time")
        return value;
...
export function coerceToString(column, operator, value) {
    const dataTypeGroup = column?.datatype.group;
