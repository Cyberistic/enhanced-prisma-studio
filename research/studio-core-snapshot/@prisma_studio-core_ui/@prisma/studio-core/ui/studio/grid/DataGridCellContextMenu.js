...
export function DataGridCellContextMenu(props) {
    ...
    const handleCopyAction = useCallback(() => {
        ...
        const content = providedCopyText ??
    ...
    return (<ContextMenu>
      ...
      <ContextMenuContent>
        <ContextMenuItem onPointerDown={() => setGridInteractionSuppressionWindow()} onSelect={() => handleCopyAction()} className="flex items-center gap-2">
          <Copy size={12}/>
          Copy
        </ContextMenuItem>
      </ContextMenuContent>
