...
function isStrictModeEnabledFromWindow() {
  return hasWindow && window.__PRISMA_STUDIO_STRICT_TANSTACK_DB__ === true;
}
...
function getDefaultMaxMutationsPerTick() {
  ...
  const override = window.__PRISMA_STUDIO_TANSTACK_DB_MAX_MUTATIONS_PER_TICK__;
  return Number.isInteger(override) && override > 0 ? override : DEFAULT_MAX_MUTATIONS_PER_TICK;
}
