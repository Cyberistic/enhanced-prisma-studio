...
export function RawInput(props) {
    ...
    <div onKeyDown={handleKeyDown}>
      <Input aria-required={isRequired} className="cell-input-leading border-none shadow-none focus-visible:ring-0 resize-none px-(--studio-cell-spacing)" disabled={readonly} onChange={handleOnChange} required={isRequired} type="text" value={inputValue}/>
