  ...
  const filterMenuTrigger = (
    <PopoverTrigger asChild>
      <button
        ...
        type="button"
        className={cn(
          "flex h-9 shrink-0 items-center gap-1.5 bg-transparent px-3 text-sm transition-colors focus-visible:outline-none",
          disabled && "opacity-70",
          isAiFilterVisible
      ...
      >
        <PopoverTrigger asChild>
          <button
            ...
            className="flex h-6 min-h-0 min-w-10 appearance-none items-center justify-center rounded-none border-0 border-r border-table-border bg-transparent px-2 py-0 text-[11px] leading-none font-sans font-medium text-muted-foreground shadow-none transition-colors hover:bg-accent hover:text-accent-foreground"
            onClick={() => {
              setIsEditing(true);
      ...
      <div className="min-w-16 border-r border-table-border">
        {isEditing ? (
          <Input
            ...
            className="h-6 min-h-0 rounded-none border-0 bg-transparent px-2 py-0 text-xs leading-none font-sans font-normal shadow-none focus-visible:ring-0"
          ...
          <button
            type="button"
            className="flex h-6 min-h-0 w-full min-w-0 appearance-none items-center rounded-none border-0 bg-transparent px-2 py-0 text-left text-xs leading-none font-sans shadow-none transition-colors hover:bg-accent hover:text-accent-foreground"
            onClick={() => {
              setIsEditing(true);
              focusValueInput();
            }}
...
function InlineTableFilterGroupPill(props) {
  ...
  return (
    <div className="inline-flex items-center gap-1.5 rounded-full border border-dashed border-table-border bg-background/95 px-2 py-1 text-xs shadow-sm">
