...
function formatQualifiedTableName(dialect, table) {
...
function shouldAppendWhereClauseExcerpt(message) {
...
function getWhereClauseExcerpt(args) {
    ...
    const relativeOffset = normalizedClauseStart >= 0
...
function createClauseExcerpt(normalizedClause, relativeOffset) {
    if (normalizedClause.length === 0) {
        return null;
    }
