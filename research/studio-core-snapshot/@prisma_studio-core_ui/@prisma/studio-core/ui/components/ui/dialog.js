...
const DialogContent = React.forwardRef(({ className, children, container, showCloseButton = true, ...props }, ref) => (<DialogPortal container={container ?? undefined}>
      <div className="ps">
        <DialogOverlay />
...
const DialogHeader = ({ className, ...props }) => (<div className={cn("flex flex-col gap-1.5 text-center sm:text-left", className)} {...props}/>);
